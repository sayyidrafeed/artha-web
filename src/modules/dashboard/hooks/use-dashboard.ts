...
export function useDashboardSummary(year: number, month?: number): UseDashboardSummaryResult {
...
export function useDashboardByCategory(year: number, month?: number): UseDashboardByCategoryResult {
